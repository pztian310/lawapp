...
public class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.MyViewHolder> {
     ...
     */
    public void setItemOnclickListener(HomeAdapter.itemOnclickListener itemOnclickListener) {
        this.itemOnclickListener = itemOnclickListener;
    }

    public HomeAdapter(Context context, List<Case> caseList){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.adapter_freagment_home_recyclerview,viewGroup,false);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            title = itemView.findViewById(R.id.adapter_home_recyclerview_title);
            image = itemView.findViewById(R.id.adapter_home_recyclerview_image);
            type = itemView.findViewById(R.id.adapter_home_recyclerview_type);
